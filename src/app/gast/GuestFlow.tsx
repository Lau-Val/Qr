            ...
            {(() => {
              ...
              return (
                <>
                  <div
                    className={cn(
                      "shrink-0 overflow-hidden rounded-xl border px-2.5 py-[calc(0.5rem*0.9)] text-center sm:rounded-2xl sm:px-3 sm:py-[calc(0.625rem*0.9)] [@media(max-height:760px)]:py-[calc(0.5rem*0.9)]",
                      p.baseWon.card,
                    )}
                  >
                    <p
                      className={cn(
                        "text-[clamp(0.95rem,3.8vw,calc(1.125rem*0.9))] font-bold",
                        p.baseWon.label,
                      )}
                    >
                      Dit heb je gewonnen
                    ...
                    <h2
                      className={cn(
                        "mt-1.5 line-clamp-3 text-[clamp(1.05rem,4.5vw,calc(1.65rem*0.9))] font-bold leading-snug [@media(max-height:760px)]:mt-1 [@media(max-height:760px)]:line-clamp-2",
                        p.baseWon.title,
                      )}
                    >
                      {baseDeal.title}
                    ...
                    {isHorecaTemplate ? (
                      <p
                        className={cn(
                          "mt-2 text-[clamp(0.9rem,3.5vw,calc(1.125rem*0.9))] line-through decoration-white/30 [@media(max-height:760px)]:mt-1.5",
                    ...
                    >
                      <p
                        className={cn(
                          "text-[clamp(calc(0.75rem*0.9),3vw,calc(0.9rem*0.9))] font-medium leading-snug",
                          p.baseWon.timerLead,
                        )}
                      >
                      ...
                      <p
                        className={cn(
                          "font-mono text-[clamp(calc(1.25rem*0.9),5vw,calc(1.75rem*0.9))] font-bold tabular-nums tracking-tight",
                          p.baseWon.timerMono,
                        )}
                        aria-live="polite"
                      >
